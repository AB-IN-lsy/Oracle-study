...
(
    ...
    MGR     NUMBER(4),
    JOB     VARCHAR2(20),
    CONSTRAINT FK_DEPT1 FOREIGN KEY (DEPTNO) REFERENCES DEPT1 (DEPTNO)
);
/*
DROP TABLE SALGRADE;
DROP TABLE EMP1;
...
ALTER TABLE EMP1
    ADD (GRADE NUMBER
        CONSTRAINT FK_GRADE1 REFERENCES SALGRADE1 (GRADE)
        );
ALTER TABLE EMP1
    DROP (COMM);

CREATE UNIQUE INDEX emp_sname0173 ON EMP1 (ENAME);
CREATE UNIQUE INDEX e_de0173 ON EMP1 (DEPTNO ASC, ENAME DESC);

DROP INDEX emp_sname0173;
DROP INDEX e_de0173;

INSERT INTO SALGRADE1(GRADE, LOSAL, HISAL)
VALUES (1, 700, 4000);
INSERT INTO SALGRADE1(GRADE, LOSAL, HISAL)
VALUES (2, 2000, 9000);
INSERT INTO SALGRADE1(GRADE, LOSAL, HISAL)
...
INSERT INTO EMP1(EMPNO, ENAME, SAL, DEPTNO, HIREBAR, MGR, JOB, GRADE)
